...
public class Upgrader extends AssociationUpdater {
    ...
    public void createOrUpgradeTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        for (TableModel tableModel : getAllTableModels()) {
            ...
            stringBuilder.append("createOrUpgradeTable: model is ");
            stringBuilder.append(this.mTableModel.getTableName());
    ...
    private List<String> findColumnsToRemove() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("remove columns from ");
            ...
            for (ColumnModel columnModel2 : this.mTableModel.getColumnModels()) {
                if (columnModel.getColumnName().equalsIgnoreCase(columnModel2.getColumnName())) {
                    ...
                    if (!this.hasConstraintChanged) {
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("default value db is:");
                        stringBuilder.append(columnModel.getDefaultValue());
                        stringBuilder.append(", default value is:");
                        stringBuilder.append(columnModel2.getDefaultValue());
                        LitePalLog.d("AssociationUpdater", stringBuilder.toString());
    ...
    private boolean isRemovedFromClass(String str) {
        return this.mTableModel.containsColumn(str) ^ 1;
    }
    ...
    private void removeColumns(List<String> list) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("do removeColumns ");
    ...
    private List<String> getChangeColumnsConstraintsSQL() {
        ...
        for (String generateCreateTableSQL2 : arrayList) {
            LitePalLog.d("AssociationUpdater", generateCreateTableSQL2);
        }
        LitePalLog.d("AssociationUpdater", "<< generateChangeConstraintSQL");
        return arrayList;
    }
