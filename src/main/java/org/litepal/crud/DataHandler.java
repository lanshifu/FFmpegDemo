...
abstract class DataHandler extends LitePalBase {
    ...
    public <T> java.util.List<T> query(java.lang.Class<T> r17, java.lang.String[] r18, java.lang.String r19, java.lang.String[] r20, java.lang.String r21, java.lang.String r22, java.lang.String r23, java.lang.String r24, java.util.List<org.litepal.crud.model.AssociationsInfo> r25) {
        /*
        r16 = this;
        r1 = r16;
        r0 = r25;
        ...
        r9 = org.litepal.util.DBUtility.convertSelectClauseToValidNames(r6);	 Catch:{ Exception -> 0x0098 }
    ...
    L_0x004a:
        ...
        r9 = r8;
        r9 = (org.litepal.crud.LitePalSupport) r9;	 Catch:{ Exception -> 0x0092, all -> 0x0090 }
        r10 = "id";
    ...
    L_0x0098:
        r0 = move-exception;
    L_0x0099:
        r2 = new org.litepal.exceptions.LitePalSupportException;	 Catch:{ all -> 0x0095 }
    ...
    L_0x004b:
        r11 = move-exception;
    L_0x004c:
        r10 = new org.litepal.exceptions.LitePalSupportException;	 Catch:{ all -> 0x0048 }
    ...
    /* JADX WARNING: Missing block: B:13:0x0027, code skipped:
            throw new org.litepal.exceptions.LitePalSupportException(r5.getMessage(), r5);
     */
    public org.litepal.crud.LitePalSupport getEmptyModel(org.litepal.crud.LitePalSupport r5) {
        /*
        r4 = this;
    ...
    L_0x0007:
        ...
        r0 = (org.litepal.crud.LitePalSupport) r0;	 Catch:{ ClassNotFoundException -> 0x0044, InstantiationException -> 0x001b, Exception -> 0x001d }
    ...
    L_0x001d:
        r5 = move-exception;
        r0 = new org.litepal.exceptions.LitePalSupportException;
        r1 = r5.getMessage();
        r0.<init>(r1, r5);
        throw r0;
    L_0x0028:
        ...
        r5 = r3;
    L_0x002c:
        r1 = new org.litepal.exceptions.LitePalSupportException;
    ...
    L_0x0043:
        r5 = r0;
    L_0x0044:
        r0 = new org.litepal.exceptions.DatabaseGenerateException;
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.litepal.crud.DataHandler.getEmptyModel(org.litepal.crud.LitePalSupport):org.litepal.crud.LitePalSupport");
    }
    ...
    L_0x000e:
        ...
        r1 = 0;
        r2 = r0.get(r9);
        r2 = (org.litepal.tablemanager.model.GenericModel) r2;
    ...
    L_0x002c:
        r2 = org.litepal.util.DBUtility.getM2MSelfRefColumnName(r9);
        r3 = "getLong";
        goto L_0x003f;
    L_0x0033:
        r2 = r9.getName();
        r2 = org.litepal.util.DBUtility.convertToValidColumnName(r2);
        r3 = r7.genGetColumnMethod(r9);
    L_0x003f:
        r4 = r21.getClassName();
        r5 = r9.getName();
        r4 = org.litepal.util.DBUtility.getGenericTableName(r4, r5);
        r5 = r21.getClassName();
        r5 = org.litepal.util.DBUtility.getGenericValueIdColumnName(r5);
        r6 = new org.litepal.tablemanager.model.GenericModel;
        r6.<init>();
        r6.setTableName(r4);
    ...
    L_0x00b2:
        r1 = org.litepal.util.BaseUtility.changeCase(r18);	 Catch:{ all -> 0x00d5 }
    ...
    L_0x0015:
        r1 = r8.next();
        r9 = r1;
        r9 = (org.litepal.crud.model.AssociationsInfo) r9;
    ...
    L_0x0037:
        ...
        r3 = org.litepal.util.DBUtility.getTableNameByClassName(r10);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        r5 = org.litepal.util.DBUtility.getIntermediateTableName(r2, r3);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        ...
        r2 = org.litepal.util.BaseUtility.changeCase(r2);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        ...
        r1 = org.litepal.Operator.findBySQL(r1);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        goto L_0x00de;
    L_0x0099:
        r1 = r9.getSelfClassName();	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        r1 = org.litepal.util.DBUtility.getTableNameByClassName(r1);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        r1 = r7.getForeignKeyColumnName(r1);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        r2 = org.litepal.util.DBUtility.getTableNameByClassName(r10);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        r3 = r7.mDatabase;	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        r18 = org.litepal.util.BaseUtility.changeCase(r2);	 Catch:{ Exception -> 0x0198, all -> 0x0194 }
        r19 = 0;
    ...
    L_0x00f1:
        ...
        r4 = r1;
        r4 = (org.litepal.crud.LitePalSupport) r4;	 Catch:{ Exception -> 0x0185, all -> 0x017f }
        r1 = "id";
    ...
    L_0x0159:
        ...
        org.litepal.crud.DynamicExecutor.setField(r0, r1, r4, r5);	 Catch:{ Exception -> 0x017d, all -> 0x017b }
    L_0x0164:
    ...
    L_0x0198:
        ...
        r1 = 0;
    L_0x019a:
        r2 = new org.litepal.exceptions.LitePalSupportException;	 Catch:{ all -> 0x01a4 }
