...
abstract class BaseParams {
    ...
    private synchronized void checkBodyParams() {
        ...
        r2 = this;
        monitor-enter(r2);
        r0 = r2.bodyParams;	 Catch:{ all -> 0x0086 }
        r0 = r0.isEmpty();	 Catch:{ all -> 0x0086 }
        if (r0 == 0) goto L_0x000b;
    L_0x0009:
        monitor-exit(r2);
        return;
    L_0x000b:
        r0 = r2.method;	 Catch:{ all -> 0x0086 }
        r0 = org.xutils.http.HttpMethod.permitsRequestBody(r0);	 Catch:{ all -> 0x0086 }
        if (r0 == 0) goto L_0x001f;
    L_0x0013:
        r0 = r2.bodyContent;	 Catch:{ all -> 0x0086 }
        r0 = android.text.TextUtils.isEmpty(r0);	 Catch:{ all -> 0x0086 }
        if (r0 == 0) goto L_0x001f;
    L_0x001b:
        r0 = r2.requestBody;	 Catch:{ all -> 0x0086 }
        if (r0 == 0) goto L_0x002b;
    L_0x001f:
        r0 = r2.queryStringParams;	 Catch:{ all -> 0x0086 }
        r1 = r2.bodyParams;	 Catch:{ all -> 0x0086 }
    ...
    L_0x0033:
        r0 = r2.multipart;	 Catch:{ all -> 0x0086 }
        if (r0 != 0) goto L_0x003f;
    L_0x0037:
        r0 = r2.fileParams;	 Catch:{ all -> 0x0086 }
        r0 = r0.size();	 Catch:{ all -> 0x0086 }
        if (r0 <= 0) goto L_0x004b;
    L_0x003f:
        r0 = r2.fileParams;	 Catch:{ all -> 0x0086 }
        r1 = r2.bodyParams;	 Catch:{ all -> 0x0086 }
        ...
        r0.clear();	 Catch:{ all -> 0x0086 }
    L_0x004b:
        r0 = r2.asJsonContent;	 Catch:{ all -> 0x0086 }
    ...
    L_0x004f:
        ...
        if (r0 != 0) goto L_0x0084;
    L_0x0057:
        r0 = r2.bodyContent;	 Catch:{ JSONException -> 0x007d }
        r0 = android.text.TextUtils.isEmpty(r0);	 Catch:{ JSONException -> 0x007d }
        if (r0 != 0) goto L_0x0067;
    L_0x005f:
        r0 = new org.json.JSONObject;	 Catch:{ JSONException -> 0x007d }
        r1 = r2.bodyContent;	 Catch:{ JSONException -> 0x007d }
    ...
    L_0x006c:
        r1 = r2.bodyParams;	 Catch:{ JSONException -> 0x007d }
        r2.params2Json(r0, r1);	 Catch:{ JSONException -> 0x007d }
        r0 = r0.toString();	 Catch:{ JSONException -> 0x007d }
        r2.bodyContent = r0;	 Catch:{ JSONException -> 0x007d }
        r0 = r2.bodyParams;	 Catch:{ JSONException -> 0x007d }
        r0.clear();	 Catch:{ JSONException -> 0x007d }
        goto L_0x0084;
    L_0x007d:
        r0 = move-exception;
        r1 = new java.lang.RuntimeException;	 Catch:{ all -> 0x0086 }
