...
public class IjkMediaCodecInfo {
    ...
    public static String getLevelName(int i) {
        switch (i) {
            ...
            case 16:
                return "13";
            case 32:
                return ConnectSocketParams.EFFECT_TYPE_BIG;
            case 64:
                return "21";
            case 128:
                return "22";
    ...
    public static IjkMediaCodecInfo setupCandidate(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        boolean startsWith = toLowerCase.startsWith("omx.");
    ...
    public void dumpProfileLevels(String str) {
        if (VERSION.SDK_INT >= 16) {
            try {
                ...
                Log.i(TAG, String.format(Locale.US, "%s", new Object[]{getProfileLevelName(i, i2)}));
            } catch (Throwable unused) {
