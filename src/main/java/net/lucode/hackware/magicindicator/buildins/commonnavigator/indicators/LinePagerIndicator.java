...
public class LinePagerIndicator extends View implements aal {
    private int a;
    ...
    private void a(Context context) {
        ...
        this.e = (float) aai.a(context, 3.0d);
        this.g = (float) aai.a(context, 10.0d);
    }
    ...
    public void a(int i, float f, int i2) {
        if (this.j != null && !this.j.isEmpty()) {
            ...
            aan a = a.a(this.j, i);
            aan a2 = a.a(this.j, i + 1);
            if (this.a == 0) {
                f2 = ((float) a.a) + this.f;
                f3 = ((float) a2.a) + this.f;
                f4 = ((float) a.c) - this.f;
                f5 = ((float) a2.c) - this.f;
            } else if (this.a == 1) {
                f2 = ((float) a.e) + this.f;
                f3 = ((float) a2.e) + this.f;
                f4 = ((float) a.g) - this.f;
                f5 = ((float) a2.g) - this.f;
            } else {
                f2 = ((float) a.a) + ((((float) a.a()) - this.g) / 2.0f);
                f3 = ((float) a2.a) + ((((float) a2.a()) - this.g) / 2.0f);
                f4 = ((((float) a.a()) + this.g) / 2.0f) + ((float) a.a);
                f5 = ((((float) a2.a()) + this.g) / 2.0f) + ((float) a2.a);
            }
            this.l.left = f2 + ((f3 - f2) * this.b.getInterpolation(f));
            this.l.right = f4 + ((f5 - f4) * this.c.getInterpolation(f));
