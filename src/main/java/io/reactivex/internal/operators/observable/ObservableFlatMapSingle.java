...
public final class ObservableFlatMapSingle<T, R> extends a<T, R> {
    ...
    static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements b, r<T> {
        ...
        final class InnerObserver extends AtomicReference<b> implements b, u<R> {
        ...
        FlatMapSingleObserver(r<? super R> rVar, wm<? super T, ? extends v<? extends R>> wmVar, boolean z) {
        ...
        public void onNext(T t) {
            try {
                v vVar = (v) io.reactivex.internal.functions.a.a(this.mapper.apply(t), "The mapper returned a null SingleSource");
    ...
    public ObservableFlatMapSingle(p<T> pVar, wm<? super T, ? extends v<? extends R>> wmVar, boolean z) {
        super(pVar);
        this.b = wmVar;
        this.c = z;
    }
