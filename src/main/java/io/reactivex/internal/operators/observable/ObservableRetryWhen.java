...
public final class ObservableRetryWhen<T> extends a<T, T> {
    final wm<? super k<Throwable>, ? extends p<?>> b;
    ...
    static final class RepeatWhenObserver<T> extends AtomicInteger implements b, r<T> {
        ...
        RepeatWhenObserver(r<? super T> rVar, c<Throwable> cVar, p<T> pVar) {
    ...
    public ObservableRetryWhen(p<T> pVar, wm<? super k<Throwable>, ? extends p<?>> wmVar) {
        super(pVar);
        this.b = wmVar;
    }
