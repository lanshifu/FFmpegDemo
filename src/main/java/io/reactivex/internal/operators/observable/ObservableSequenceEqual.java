...
public final class ObservableSequenceEqual<T> extends k<Boolean> {
    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements b {
        ...
        EqualCoordinator(r<? super Boolean> rVar, int i, p<? extends T> pVar, p<? extends T> pVar2, wi<? super T, ? super T> wiVar) {
    ...
    public ObservableSequenceEqual(p<? extends T> pVar, p<? extends T> pVar2, wi<? super T, ? super T> wiVar, int i) {
        this.a = pVar;
        this.b = pVar2;
        this.c = wiVar;
        this.d = i;
