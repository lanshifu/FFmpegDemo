...
public final class ObservableFlatMapCompletableCompletable<T> extends a implements wx<T> {
    final p<T> a;
    ...
    static final class FlatMapCompletableMainObserver<T> extends AtomicInteger implements b, r<T> {
        ...
        FlatMapCompletableMainObserver(io.reactivex.b bVar, wm<? super T, ? extends c> wmVar, boolean z) {
    ...
    public ObservableFlatMapCompletableCompletable(p<T> pVar, wm<? super T, ? extends c> wmVar, boolean z) {
        this.a = pVar;
        this.b = wmVar;
        this.c = z;
    }
    ...
    public k<T> j_() {
        return xk.a(new ObservableFlatMapCompletable(this.a, this.b, this.c));
    }
}
