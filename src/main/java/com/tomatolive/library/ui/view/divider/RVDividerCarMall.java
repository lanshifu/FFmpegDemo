...
public class RVDividerCarMall extends Y_DividerItemDecoration {
    ...
    public Y_Divider getDivider(int i) {
        ...
        if (this.isHeadView) {
            ...
            return new Y_DividerBuilder().setRightSideLine(true, ContextCompat.getColor(this.context, this.colorRes), CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).setLeftSideLine(true, ContextCompat.getColor(this.context, this.colorRes), CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).setTopSideLine(true, ContextCompat.getColor(this.context, this.colorRes), 10.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).setBottomSideLine(false, ContextCompat.getColor(this.context, this.colorRes), CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).create();
        }
        switch (i % 2) {
            case 0:
                create = new Y_DividerBuilder().setRightSideLine(true, ContextCompat.getColor(this.context, this.colorRes), 5.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).setLeftSideLine(true, ContextCompat.getColor(this.context, this.colorRes), 10.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).setBottomSideLine(true, ContextCompat.getColor(this.context, this.colorRes), 10.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).setTopSideLine(true, ContextCompat.getColor(this.context, this.colorRes), getTopDp(i), CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO).create();
