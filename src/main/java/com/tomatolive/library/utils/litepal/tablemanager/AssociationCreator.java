...
public abstract class AssociationCreator extends Generator {
    ...
    public void giveTableSchemaACopy(java.lang.String r5, int r6, android.database.sqlite.SQLiteDatabase r7) {
        ...
        r2.append(r0);
        r2 = r2.toString();
        com.tomatolive.library.utils.litepal.util.LitePalLog.d(r1, r2);
        r1 = 0;
    ...
    L_0x0031:
        ...
        r3 = "name";
        r5 = com.tomatolive.library.utils.litepal.util.BaseUtility.changeCase(r5);	 Catch:{ Exception -> 0x0055, all -> 0x0053 }
    ...
    L_0x006a:
        throw r5;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tomatolive.library.utils.litepal.tablemanager.AssociationCreator.giveTableSchemaACopy(java.lang.String, int, android.database.sqlite.SQLiteDatabase):void");
    }
