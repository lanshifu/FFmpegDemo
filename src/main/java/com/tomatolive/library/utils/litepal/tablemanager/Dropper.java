...
public class Dropper extends AssociationUpdater {
    ...
    L_0x0034:
        ...
        com.tomatolive.library.utils.litepal.util.LitePalLog.d(r3, r4);	 Catch:{ Exception -> 0x0056 }
    ...
    L_0x006e:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tomatolive.library.utils.litepal.tablemanager.Dropper.findTablesToDrop():java.util.List");
    }
