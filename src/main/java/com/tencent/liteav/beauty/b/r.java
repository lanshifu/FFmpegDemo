    ...
    public void a(float f, final Bitmap bitmap, float f2, final Bitmap bitmap2, float f3) {
        ...
        a((Runnable) new Runnable() {
            public void run() {
                ...
                r.this.w = bitmap2;
                if (bitmap != null) {
                    r.this.u = i.a(bitmap, r.this.u, false);
                    r.this.D[0] = 1.0f;
                } else {
                    if (r.this.u != -1) {
                    ...
                    r.this.u = -1;
                    r.this.D[0] = CropImageView.DEFAULT_ASPECT_RATIO;
                }
                if (bitmap2 != null) {
                    r.this.y = i.a(bitmap2, r.this.y, false);
                    r.this.D[1] = 1.0f;
                    return;
                }
                if (r.this.y != -1) {
                ...
                r.this.y = -1;
                r.this.D[1] = CropImageView.DEFAULT_ASPECT_RATIO;
            }
        });
    }

    public void a(float f) {
        a(this.r, f, CropImageView.DEFAULT_ASPECT_RATIO);
    }
