...
public class b extends ac {
    ...
    public void a(float f) {
        ...
        stringBuilder.append("setBrightLevel ");
        stringBuilder.append(f);
        TXCLog.i("BeautyBlend", stringBuilder.toString());
        a(this.s, f);
    }

    public void b(float f) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setRuddyLevel level ");
        stringBuilder.append(f);
        Log.i("BeautyBlend", stringBuilder.toString());
        a(this.t, f / 2.0f);
    }
