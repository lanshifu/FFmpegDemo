...
public class aj extends g {
    ...
    private final float[] y = new float[]{1.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f};
    ...
    public void a(float f, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            float[] fArr2 = fArr;
            Matrix.multiplyMM(this.z, 0, fArr2, 0, this.z, 0);
            Matrix.setIdentityM(fArr, 0);
