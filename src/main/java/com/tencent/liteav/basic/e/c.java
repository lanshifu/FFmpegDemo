...
public class c {
    ...
    public void a() {
        ...
        if (eglGetError != 12288) {
            ...
            stringBuilder.append("EGL error:");
        ...
        if (this.c != EGL14.EGL_NO_DISPLAY) {
            ...
            if (EGL14.eglInitialize(this.c, iArr, 0, iArr, 1)) {
                ...
                if (eGLConfig2 != null) {
                    ...
                    if (!EGL14.eglChooseConfig(this.c, surface2 == null ? l : k, 0, eGLConfigArr, 0, eGLConfigArr.length, new int[1], 0)) {
                        return false;
                    }
                ...
                this.d = EGL14.eglCreateContext(this.c, this.e, eGLContext2, new int[]{12440, a, 12344}, 0);
                int[] iArr2 = new int[]{12344};
                ...
                if (surface2 == null) {
                    ...
                    this.i = EGL14.eglCreateWindowSurface(this.c, this.e, surface2, iArr2, 0);
                }
                a();
