...
public class d extends g {
    ...
    public void a(int i, int i2) {
        ...
        if (i != 0 && ((double) this.v) != 0.0d) {
            a(this.u, new float[]{this.v / ((float) this.e), CropImageView.DEFAULT_ASPECT_RATIO});
        }
    }
    ...
    private void a(float f, float f2, float f3) {
        this.v = f;
        if (this.e != 0) {
            a(this.u, new float[]{f / ((float) this.e), CropImageView.DEFAULT_ASPECT_RATIO});
        }
        this.r.a(this.t, f3);
        this.r.a(this.s, f2);
    }
