...
public class n {
    ...
    private g i = null;
    private b j = null;
    private com.tencent.liteav.e k = null;
    private com.tencent.liteav.f l = null;
    private l m = null;
    private m n = null;
    private d o = null;
    private a p = null;
    ...
    public static class d extends n {
        ...
        public float[] f = new float[]{CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO};
        public float[] g = new float[]{CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO};
        public float[] h = new float[]{CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO};
    }
    ...
    public static class k extends l {
        public float[] a = new float[]{CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO};
        public float[] b = new float[]{CropImageView.DEFAULT_ASPECT_RATIO, 0.1f};
        public float[] c = new float[]{CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO};
    }
    ...
    private void k(int i, int i2) {
        if (this.k == null) {
            this.k = new com.tencent.liteav.e();
            this.k.a(true);
            if (!this.k.c()) {
                TXCLog.e("VideoEffect", "mDiffuseFilter.init failed");
                return;
    ...
    private void l(int i, int i2) {
        if (this.l == null) {
            this.l = new com.tencent.liteav.f();
            this.l.a(true);
            if (!this.l.c()) {
                TXCLog.e("VideoEffect", "mDiffuseFilter.init failed");
                return;
