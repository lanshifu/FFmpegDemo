...
public class TXCYuvTextureRender {
    ...
    private float[] mTextureCoordinates = new float[]{CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, 1.0f, 1.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, CropImageView.DEFAULT_ASPECT_RATIO};
    ...
    private void reloadFrameBuffer() {
        if (this.mNeedReLoadFrameBuffer) {
            ...
            stringBuilder.append(this.mFrameBufferID);
            stringBuilder.append(", texture id = ");
            stringBuilder.append(this.mFrameBufferTextureID);
            TXCLog.d(str, stringBuilder.toString());
