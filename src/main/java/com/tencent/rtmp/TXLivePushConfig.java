...
public class TXLivePushConfig {
    ...
    int mPauseTime = IjkMediaCodecInfo.RANK_SECURE;
    ...
    int mWatermarkX = 0;
    float mWatermarkXF = CropImageView.DEFAULT_ASPECT_RATIO;
    int mWatermarkY = 0;
    float mWatermarkYF = CropImageView.DEFAULT_ASPECT_RATIO;
