...
public final class Http2 {
    ...
    static {
        ...
        for (int i2 = 0; i2 < BINARY.length; i2++) {
            BINARY[i2] = Util.format("%8s", new Object[]{Integer.toBinaryString(i2)}).replace(' ', '0');
        }
        FLAGS[0] = "";
        FLAGS[1] = "END_STREAM";
        int[] iArr = new int[]{1};
    ...
    static String frameLog(boolean z, int i, int i2, byte b, byte b2) {
        String format = b < FRAME_NAMES.length ? FRAME_NAMES[b] : Util.format("0x%02x", new Object[]{Byte.valueOf(b)});
