...
final class Http2Writer implements Closeable {
    ...
    public synchronized void pushPromise(int i, int i2, List<Header> list) throws IOException {
        ...
        long j = (long) min;
        frameHeader(i, min + 4, (byte) 5, a == j ? (byte) 4 : (byte) 0);
        this.sink.i(i2 & Filter.MAX);
    ...
    public void dataFrame(int i, byte b, c cVar, int i2) throws IOException {
    ...
    public void frameHeader(int i, int i2, byte b, byte b2) throws IOException {
        ...
        } else if ((CheckView.UNCHECKED & i) == 0) {
            writeMedium(this.sink, i2);
            this.sink.k(b & 255);
            this.sink.k(b2 & 255);
            this.sink.i(i & Filter.MAX);
        } else {
