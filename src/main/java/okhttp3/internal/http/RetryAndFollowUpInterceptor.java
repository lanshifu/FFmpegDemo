...
public final class RetryAndFollowUpInterceptor implements Interceptor {
        ...
        if (response != null) {
            ...
            switch (code) {
                ...
                case 408:
                    ...
                    return null;
                case 503:
                    if ((response.priorResponse() == null || response.priorResponse().code() != 503) && retryAfter(response, Filter.MAX) == 0) {
                        return response.request();
                    }
                    return null;
                default:
    ...
    private int retryAfter(Response response, int i) {
        ...
        return header.matches("\\d+") ? Integer.valueOf(header).intValue() : Filter.MAX;
    }
