...
public final class PublicSuffixDatabase {
    ...
    public String getEffectiveTldPlusOne(String str) {
        if (str != null) {
            ...
            for (length = 
/*
Method generation error in method: okhttp3.internal.publicsuffix.PublicSuffixDatabase.getEffectiveTldPlusOne(java.lang.String):java.lang.String, dex: 
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r0_6 'length' int) = (r0_3 'length' int), (r0_5 'length' int) binds: {(r0_3 'length' int)=B:9:0x0029, (r0_5 'length' int)=B:10:0x002d} in method: okhttp3.internal.publicsuffix.PublicSuffixDatabase.getEffectiveTldPlusOne(java.lang.String):java.lang.String, dex: 
